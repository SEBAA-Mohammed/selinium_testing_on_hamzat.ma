...
public class SearchTest {
    ...
    @BeforeEach
    void setUp() {
        System.setProperty("webdriver.chrome.driver", "C:/Users/othma/Desktop/licence_GL/S6/test et validation/chromedriver-win64/chromedriver-win64/chromedriver.exe");
    ...
    void testRechercheProduit() {
        ...
        assertTrue(resultsContainer.isDisplayed(), "❌ Le conteneur '.products' n’est pas affiché. Aucun résultat trouvé.");

        // 4. Récupérer tous les produits
        List<WebElement> produits = resultsContainer.findElements(By.cssSelector("article.product-miniature")); // adapte cette classe si nécessaire
